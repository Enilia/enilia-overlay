			...
			controller:['$scope', '$document',
				function($scope, $document) {
					...
					$scope.colsCollection = [
						...
						{label:  'Best Attack',value: 'maxhit'},{label:  'Best Damage',value: 'MAXHIT'},
						{label:  'Healed',value: 'healed'},{label:  'Healed (%)',value: 'healedPct'},{label:  'Enchps',value: 'enchps'},
						{label:  'Crit Heals',value: 'critheals'},
						{label:  'Crit Heals (%)',value: 'crithealPct'},{label:  'Heals',value: 'heals'},
						{label:  'Best Heal',value: 'maxheal'},{label:  'Max Heal',value: 'MAXHEAL'},
						{label:  'Damage Taken',value: 'damagetaken'},{label:  'Heals Taken',value: 'healstaken'},
					...
					/*
						{label:  'Damage (m)',value: 'damage-m'},{label:  'Damage (k)',value: 'DAMAGE-k'},{label:  'Damage(M)',value: 'DAMAGE-m'},
						{label:  'DPS',value: 'DPS'},{label:  'DPS (k)',value: 'DPS-k'},
						{label:  'ENCDPS',value: 'ENCDPS'},{label:  'ENCDPS (k)',value: 'ENCDPS-k'},
						{label:  'Hit Failed',value: 'hitfailed'},
						{label:  'Swings',value: 'swings'},
						{label:  'ACCURACY',value: 'TOHIT'},
						{label:  'ENCHPS',value: 'ENCHPS'},{label:  'ENCHPS (k)',value: 'ENCHPS-k'},
						{label:  'Cures',value: 'cures'},
						{label:  'Best Heal Ward',value: 'maxhealward'},{label:  'Max Heal Ward',value: 'MAXHEALWARD'},
						{label:  'Powerdrain',value: 'powerdrain'},
						{label:  'Powerheal',value: 'powerheal'},
						{label:  'Threat Str',value: 'threatstr'},{label:  'Threat Delta',value: 'threatdelta'},
